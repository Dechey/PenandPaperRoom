...
namespace Photon.Voice.Unity
{
    ...
    public class VoiceConnection : ConnectionHandler, ILoggable
    {
        ...
        {
            recorder = gameObject.GetComponent(typeof(Recorder)) as Recorder;
            Client.GlobalInterestGroup = 1;
        }
        ...
        protected virtual void Update()
        {
            ...
            {
                SetInterestGroup(Convert.ToByte(recorder.InterestGroup + 1));
        ...
        {
            Client.GlobalInterestGroup = interestGroup;
        }

        public byte GetInterestGroup()
        {
            return Client.GlobalInterestGroup;
        }
    }
}
